  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn more about Solarxen and our mission to build a smarter energy future."
        />
      </Head>
              ...
              <Col lg={6} className={styles.hero__left}>
                <div className={styles.hero__badgeRow}>
                  <Badge className={styles.sectionBadge}>
                    <span className={styles.liveDot} /> Live Network —
                    Bangladesh
                  </Badge>
                </div>
                ...
                <p className={styles.hero__sub}>
                  Solarxen helps homeowners and businesses turn rooftop space
                  into clean energy and long-term monthly income through a
                  connected solar network.
                </p>
            ...
            <Row className="align-items-center g-5">
              <Col lg={7} className="order-lg-1 order-2">
                <div className={styles.story__block}>
                  ...
                  <p className={styles.sectionSubLeft}>
                    Solarxen was created to help people unlock the hidden value
                    of their rooftops. Through solar energy generation, smart
                    monitoring, and transparent earning opportunities — we turn
                    underused space into a consistent monthly income source
                    while building a cleaner Bangladesh.
                  </p>
                  <div className={styles.story__pillars}>
                    {[
                      ...
                      <div key={i} className={styles.story__pillar}>
                        <span className={styles.story__pillarIcon}>
                          {p.icon}
                        </span>
                        <span>{p.text}</span>
                      </div>
